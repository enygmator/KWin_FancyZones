/*const divisions = {
  ...
  function shortcut (text, shortcut, placement) {
    text = 'Rectangle: ' + text
    shortcut = 'Ctrl+Meta+Alt+Shift' + shortcut
  ...
  */
  ...
  registerShortcut("KWin_fancyzones", "fancyzones_resizepos", "Meta+`", () => fancyzoneit())

  registerUserActionsMenu(function(client) {
    return {
      title: "fancyzones_resizepos",
      text: "Resize and Move",
      checkable: true,
      checked: false,
